...
export default function Editor(props) {
  ...
  //  console.log(`line no. 15 ${sections[Object.keys(sections)[0]]}`);
...
//  console.log(values);
  ...
  const handleClick = () => {
    //  console.log(sections[activeKey]);
    //  console.log(values);
    switch (sections[activeKey]) {
      case sections.basicInfo: {
        const tempDetail = {
  ...
  useEffect(() => {
    ...
    // setValues({
    //   firstName: activeInfo?.detail?.firstName || "",
    //   lastName: activeInfo?.detail?.lastName || "",
    ...
    //     : "",
    //   degree: activeInfo?.details ? activeInfo?.details[0]?.degree || "" : "",
